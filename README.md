...
[Explore Directory](#overview) • [App Demo](#-app-demo) • [API Endpoints](#api-reference) • [Submit Site](#site-submissions) • [Contributing](CONTRIBUTING.md) • [Contact](#-contact)

<br />

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="public/images/dark.png">
  <source media="(prefers-color-scheme: light)" srcset="public/images/light.png">
  <img src="public/images/dark.png" alt="Portalix App Demo" width="100%" />
</picture>
...
Portalix features a clean, distraction-free interface with full dark and light mode support:

### 🌙 Dark Mode (Default)
![Portalix Dark Mode](public/images/dark.png)

### ☀️ Light Mode
![Portalix Light Mode](public/images/light.png)
...
│   └── images/             # App demo screenshots (dark & light mode)
├── src/
│   ├── data/
...
Have questions, suggestions, feedback, or need direct support? Feel free to reach out:

- **Lead Maintainer**: Shakib Khan
- **GitHub**: [@ichshakib](https://github.com/ichshakib)
- **Email**: [ichshakib@gmail.com](mailto:ichshakib@gmail.com)
- **Repository**: [https://github.com/ichshakib/portalix](https://github.com/ichshakib/portalix)
- **Issues**: [GitHub Issues](https://github.com/ichshakib/portalix/issues)
